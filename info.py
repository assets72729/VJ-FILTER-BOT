...
# Bot information
SESSION = environ.get('SESSION', 'MashaBot')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8181956369').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002325987977').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002670671084')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Talkies')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+e_FyAZNqvOg2ZGE9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KdramaTalkies')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+rb94bP5CMc41NTY1') # Support Chat Link Without https:// or @
